...
class Comfy::Admin::Cms::PagesControllerTest < ActionController::TestCase
  ...
  def test_get_new_as_child_page
    get :new, params: { :site_id => @site, :parent_id => comfy_cms_pages(:default) }
    assert_response :success
    assert assigns(:page)
  ...
  def test_get_edit_with_non_english_locale
    ...
    get :edit, params: { :site_id => site, :id => comfy_cms_pages(:default) }
    assert_response :success
  end
  ...
  def test_get_form_blocks
    site = @site
    get :form_blocks, params: { :site_id => site, :id => comfy_cms_pages(:default), :layout_id => comfy_cms_layouts(:nested).id }, xhr: true
    assert_response :success
    assert assigns(:page)
    assert_equal 2, assigns(:page).tags.size
    assert_template :form_blocks

    get :form_blocks, params: { :site_id => site, :id => comfy_cms_pages(:default), :layout_id => comfy_cms_layouts(:default).id }, xhr: true
    assert_response :success
    assert assigns(:page)
  ...
  def test_get_form_blocks_for_new_page
    get :form_blocks, params: { :site_id => @site, :id => 0, :layout_id => comfy_cms_layouts(:default).id }, xhr: true
    assert_response :success
    assert assigns(:page)
  ...
  def test_get_toggle_branch
    page = comfy_cms_pages(:default)
    get :toggle_branch, params: { :site_id => page.site, :id => page, :format => :js }, xhr: true
    assert_response :success
